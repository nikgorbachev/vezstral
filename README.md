...
Bologna has a vibrant, sharp cultural identity with a rich linguistic tapestry. Its local language is a mix of traditional *dialetto bolognese*, timeless regional expressions, and modern youth-driven street slang. Vezstral captures this unique spirit.
...
1. **The Teacher (Mistral Large 3):** We used Mistral Large 3 to generate a highly specialized synthetic dataset of ~900 multi-turn conversations. We prompted the model to act as various Bolognese personas, generating rich JSONL data encompassing casual chats, tourism advice, and slang explanations.
...
* **"Vez"** - *Friend / Mate / Bro* (The inspiration for the model's name!).
* **"Soccia!" / "Sorbole!"** - *Wow! / Damn!* (Universal expressions of surprise or emphasis).
* **"Stare in polleg"** - *To be completely relaxed / chilling.*
* **"Pilla"** - *Money.*
* **"Fare balotta"** - *Hanging out and having a good time with a group of people.*
...
* `/notebooks/3_vezstral_inference_gradio.ipynb`: The multi-tabbed Gradio Web UI tailored for both Italian speakers and international judges.
* `/data/bologna_training_data_v2.jsonl`: The synthetic training dataset.

*(Note: The fine-tuned LoRA adapter weights are hosted publicly on Hugging Face).*
